<?php
/**
 * Ofux Mailer by [ofux.pro]
 * @version : clean
**/

echo '<span hidden>ofuxmailer</span>';

$password = "ofux"; // Password 
...
print '
<head>
    <title>Ofux Mailer [ofux.pro]</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link href="https://stackpath.bootstrapcdn.com/bootswatch/3.3.7/slate/bootstrap.min.css" rel="stylesheet" >
...
print '<div class="container col-lg-6">
        <h3><font color="blue"><span class="glyphicon glyphicon-leaf"></span></font> Ofux Mailer <small>'.$leaf['version'].'</small></h3>
	...
	<a href="http://ofux.pro" target="_blank"><img height="250" width="725" src ="https://www.ofux.pro/images/banner.png" /></a>
<br><br>
