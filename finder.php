 <?php
    ...
    #   [+] Author         : Vinz Gans
    #   [+] Edited         : Mak Suha
    #   [+] Visit          : http://maxteroit.com.com/  
    ################################################################################## */
    putenv("TZ=Asia/Tokyo");
    ?>
    <head>
    <title>root@Tuing:~#./ScanBackDoor</title>
    ...
    <body>
    <center><br><font color="#339900" size="14" face="arial">root@Vinz Gans:~#./Jayalah Jandaku</font></center><br>
    <?php
    ...
    <?php
       ...
       $ceks = array('mysqli_connect', 'DB_PASSWORD', 'new msqli');
    ...
    $target= $_POST['directory'];
       ...
       $find = array('default','mysqli_connect', 'DB_PASSWORD', 'new msqli');
    ?>
       ...
       <tr><td class="me"><center>
          ...
          <table class="me" width="200">
             <tr><td class="me">
                ...
                <br><br>
                <input type="text" name="directory" value="<?= $_SERVER['DOCUMENT_ROOT'] ?>">
...
<font face="Courier New" size="3"><font color="white"><i> ©Copyright 2013 by <a href="http://marco-exploitecommunity.com/">Vinz Ganteng</a> Powered by indonesian backtrack <a href="SingleAttacker>Marco-Exploite-Community.com/</a></i></font><br></p>
    <br><br>
    </body>